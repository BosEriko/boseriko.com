...
## DEV Integration
Blogs are pulled from [dev.to](https://dev.to/boseriko).

## Resume Builder
Resume also pulls data from GitHub. Projects are pulled daily as well as the languages that I use. You can also download it as PDF.
